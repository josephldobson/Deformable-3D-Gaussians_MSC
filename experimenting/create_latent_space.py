...
def train_encoder(epochs=25, lr=0.001, batch_size=10000):
    ...
    static_points, data_points, static_trajectories, trajectories_data = filter_static(
        data_points, trajectories_data
    )
