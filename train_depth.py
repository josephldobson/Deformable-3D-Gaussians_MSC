...
from utils.loss_utils import l1_loss, ssim, kl_divergence, scale_shift_invariant_depth_loss
...
def training(dataset, opt, pipe, testing_iterations, saving_iterations):
    ...
    for iteration in range(1, opt.iterations + 1):
        ...
        loss = (1.0 - opt.lambda_dssim) * Ll1 + opt.lambda_dssim * (1.0 - ssim(image, gt_image)) + scale_shift_invariant_depth_loss(viewpoint_cam.depth, depth) * 0.1
        loss.backward()
